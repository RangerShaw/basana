...
async def main():
    ...
    exchange.subscribe_to_multi_bar_events([pair.base_symbol],"3s",  strategy.on_bar_event)
    ...
    exchange.subscribe_to_bar_events(pair.base_symbol, "3s", position_mgr.on_bar_event)
